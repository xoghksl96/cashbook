	...
	<div class="container p-5 ">
		<div class="card shadow-lg border-0 rounded-lg mt-5">
			...
			<div class="card-body">
					...
					<div class="form-floating mb-3">
						<input class="form-control" style="font-family:'궁서체'; font-size:10pt;" id="inputPassword" type="password" name="oldMemberPw"/>
						<label for="inputPassword">OLD PW</label>
					</div>
					<div class="form-floating mb-3">
						<input class="form-control" style="font-family:'궁서체'; font-size:10pt;" id="inputPassword" type="password" name="newMemberPw"/>
						<label for="inputPassword">NEW PW</label>
					</div>
					<div class="form-floating mb-3">
						<input class="form-control" style="font-family:'궁서체'; font-size:10pt;" id="inputPassword" type="password" name="newMemberPwCheck"/>
						<label for="inputPassword">NEW PW CHECK</label>
					</div>
					<div class="d-flex align-items-center justify-content-between mt-4 mb-0">
						<div style="text-align : right">
							<button type="submit" class="btn btn-primary"><span class="text">비밀번호 변경</span></button>
						</div>
					</div>
				</form>
			</div>	
